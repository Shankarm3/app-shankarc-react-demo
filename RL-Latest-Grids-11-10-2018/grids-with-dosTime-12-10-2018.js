...
//                    grids.billAccountReviewGridCCIEdits.$gridDiv.jqGrid('setLabel', 'insuranceName', '', {'text-align': 'left', 'padding-left': '16px', 'width': '236px'});
    ...
    missingChargesGrid: {
        ...
        loadGrid: function(param) { // param object holds gridDiv, data
            ...
            var timeHeaderLabel = '';
            var commentBoxWidth = 180;
            if(globalvars.client=='ADENA'){
            	commentBoxWidth = 140;
            }
            ...
            this.$gridDiv.jqGrid({
                ...
                colNames: [globalvars.localResourceMap.missing_charge_hcpc_code, globalvars.localResourceMap.missing_charge_dept_code, globalvars.localResourceMap.missing_charge_charge_code, 'ndc code', 'Modifier','',globalvars.localResourceMap.missing_charge_price,
           	                 globalvars.localResourceMap.missing_charge_add_qty, globalvars.localResourceMap.missing_charge_date_of_service, timeHeaderLabel, globalvars.localResourceMap.missing_charge_charge_description,
                ...
                colModel: [
                    ...
                    {name: 'dosTimeMissing', width: 40,  fixed: true, sortable: true,sorttype: "string",align: 'center',editable:true,hidden:(globalvars.client=="ADENA")?false:true}, 
                    {name: 'chargeDesc', index: 'chargeDesc', fixed: true, width: 150, classes: 'grid_cell_style'},
                    {name: 'response', index: 'response', fixed: true, classes: 'grid_cell_style',width:(globalvars.client=="ARDENT")? 140:commentBoxWidth},
                    {name: 'responseCode', hidden: true},
                    {name: 'predCode', hidden: true},
                    {name: 'comments', index: 'comments', fixed: true, editable: this.isEditable,  width:(globalvars.client=="ARDENT")? 100:140, editoptions: {
                            size: "15",
                            maxlength: "200",
                        },
                        classes: 'grid_cell_style'},
                ...
                onSelectRow: function(id, status, e) {
                   ...
                   //  log('missing Charges ID clicked ' + id + " " + grids.missingChargesGrid.selectedRow);
                    $('#' + id + '_' + 'dosTimeMissing').timepicker({'timeFormat': 'H:i' ,'step': 15 });
                    
                    //uncomment for validation at field level
                    /*$('#' + id + '_' + 'dosTimeMissing').off("blur").on('blur', function(e){
                 		priceValue = $(this).val();
                 		if(!(/^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/.test($(this).val()))){
                 			$(this).val("");
                 			dialogs.messageDialog.show({ title: globalvars.localResourceMap.time_error_title, text: globalvars.localResourceMap.time_error_message })
                 		}
                    })*/
...
//                sortorder: 'asc',
                ...
                colNames: ['id', globalvars.localResourceMap.other_discoved_charge_search, globalvars.localResourceMap.other_discoved_charge_hcpc_code,
                    ...
                    '',globalvars.localResourceMap.other_discoved_charge_price, globalvars.localResourceMap.other_discoved_charge_add_qty, globalvars.localResourceMap.other_charge_date_of_service, timeHeaderLabel, globalvars.localResourceMap.other_discoved_charge_comment,
...
//                        }
                    ...
                    {name: 'dosTimeOTher', width: 40,  fixed: true, sortable: true,sorttype: "string",align: 'center',editable:true,hidden:(globalvars.client=="ADENA")?false:true}, 
                    {name: 'comments', index: 'comments', editable: this.isEditable, width: commentBoxWidth, fixed: true,sortable: false,  editoptions: {
                            size: "24",
                            maxlength: "250",
                        },
                        classes: 'grid_cell_style'},
...
//                  },
                onSelectRow: function(id) {
                   ...
                   // console.log("rowData.rowEditable::::::  " + rowData.rowEditable);
                    ...
                    $('#' + id + '_' + 'dosTimeOTher').timepicker({'timeFormat': 'H:i' ,'step': 15 });
                    
                    //uncomment for validation at field level
                    /*$('#' + id + '_' + 'dosTimeOTher').off("blur").on('blur', function(e){
                 		priceValue = $(this).val();
                 		if(!(/^(0[0-9]|1[0-9]|2[0-3]):[0-5][0-9]$/.test($(this).val()))){
                 			$(this).val("");
                 			dialogs.messageDialog.show({ title: globalvars.localResourceMap.time_error_title, text: globalvars.localResourceMap.time_error_message })
