        ...
        loadGrid: function(param) { // param object holds gridDiv, data
            ...
            this.$gridDiv.jqGrid({
                ...
                colModel: [
                    ...
                    {name: 'price', index: 'price', width: 60, fixed: true, sortable: true, sorttype: "int", align: "right",formatter:'currency',editable:true,edittype:"text",
                     formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", prefix: "$",decimalPlaces: 2, defaultValue: '0.00' },
                     editoptions: {
...
//                        }
                    ...
                    {name: 'price', index: 'price', width: 90, fixed: true, sortable: false, sorttype: "int", align: "center",formatter:'currency',editable:true,edittype:"text",
                     formatoptions: { decimalSeparator: ".", thousandsSeparator: ",", prefix: "$",decimalPlaces: 2, defaultValue: '0.00'},
                     editoptions: {
                         dataInit: function(element) {
                         	$(element).keypress(function(e){
