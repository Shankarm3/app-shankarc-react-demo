widgets.performanceSummaryChart = {
    summaryChartTemplate: "",

    initialize: function (params) {

        log('initializing summary chart widget-2');
    ...
    loadData: function () {
    	if(this.summaryChartTemplate==""){
    		this.summaryChartTemplate = getTemplate('common/templates/widgets/performance_summary_chart.html?123');
    	}
    },

    drawWidget: function ($summaryDiv) {

        $summaryDiv.append($.nano(widgets.performanceSummaryChart.summaryChartTemplate, globalvars.localResourceMap));
    ...
    showData: function (param) {
        ...
        log('showing data in summary chart widget-2');
    	...
    	$("#current_month_review_rate").text(param.current.reviewedCount);
    	$("#current_month_hit_rate").text(param.current.hitCount);
