...
import LeftContainerInsightDetail from './LeftContainerInsightDetail.js';
import MiddleContainerInsightDetail from './MiddleContainerInsightDetail.js';
						...
						<div className="row mt-20">
							<div className="col-sm-3">
							  <div id="left_container" className="left_container">
								<LeftContainerInsightDetail/>
							  </div>
							</div>
							<div className="col-sm-9 sidebar" id="middle_container">
								<MiddleContainerInsightDetail/>
							</div>
						</div>
					</div>
				</div>
