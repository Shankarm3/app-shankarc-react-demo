		...
		return (
			...
			<div className="row">
				<div className="chart-column col-sm-6">
					<div className="dashboard-charts" ref="chart1"></div>
				</div>
				<div className="chart-column col-sm-6">
					<div className="dashboard-charts" ref="chart2"></div>
				</div>
			</div>
			<div className="row">
				<div className="chart-column col-sm-6">
					<div className="dashboard-charts" ref="chart3"></div>
				</div>
				<div className="chart-column col-sm-6">
					<div className="dashboard-charts" ref="chart4"></div>
				</div>
			</div>
			<div className="row">
				<div className="chart-column col-sm-6">
