            ...
            app.createScreenMenu.initialize([
                ...
                {name: "auditorPerformance", title: globalvars.localResourceMap.supervisor_menu7,visible:true},
                {
                    ...
                    submenuModel: [
                        ...
                        {name: "workloadManager", title: 'Workload Manager',visible:true},
                ...
                },
                {
                    ...
                    submenuModel: [
									...
									{name: "confirmCharges", title: globalvars.localResourceMap.central_auditor_confirmed_charges_label,visible:true,parameters: {showPType:true}},
								     ...
								     {name: "editChargesCCIEdits", title: 'Submitted Coding Edits', parameters: {accountDetailsEditable: false,
									         accountDetailsHidden:false,
									         showSave: false,
									         showSubmit: false,
									         showAddRow: false,
    ...
    checkLoadedHospitals: function () {
    	...
    	$.when(
            ...
            if (globalvars.preHospitals === undefined){
            	globalvars["preHospitals"] = data1[0];
            }

            if (globalvars.postHospitals === undefined){
            	globalvars["postHospitals"] = data2[0];
            }

            if(globalvars.root.enableCodingEdits){
    	        if (globalvars.cciHospitals === undefined){
                	globalvars["cciHospitals"] = data3[0];
    	        }
            }
